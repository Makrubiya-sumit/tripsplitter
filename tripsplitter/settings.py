"""
Django settings for tripsplitter project.
"""
...
# Change this before deploying. You can generate a new one with:
...
ROOT_URLCONF = 'tripsplitter.urls'
...
WSGI_APPLICATION = 'tripsplitter.wsgi.application'
